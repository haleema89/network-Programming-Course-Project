...
main() – connecting to the server and showing menu client = socket.socket(socket.AF_INET, socket.SOCK_STREAM) client.connect((SERVER_HOST, SERVER_PORT)) client.send(client_name.encode())
